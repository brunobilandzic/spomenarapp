...
export const IMAGE_CHANGE_FAILURE = "IMAGE_CHANGE_FAILURE";
export const IMAGE_CHANGE_SUCCESS = "IMAGE_CHANGE_SUCCESS";
export const FETCH_IMAGES = "FETCH_IMAGES";
export const FETCH_IMAGES_FAILURE = "FETCH_IMAGES_FAILURE";
export const CLEAR_IMAGES = "CLEAR_IMAGES";
export const LOAD_ANSWERS_COUNTS = "LOAD_ANSWERS_COUNTS";
export const CLEAR_ANSWERS_COUNT = "CLEAR_ANSWERS_COUNT";
export const UPDATE_HASH = "UPDATE_HASH";
export const GRANT_PROFILE_DELETION = "GRANT_PROFILE_DELETION";
export const DENY_PROFILE_DELETION = "DENY_PROFILE_DELETION";
export const PROFILE_DELETION_SUCCESS = "PROFILE_DELETION_SUCCESS";
